...
void setup()
{
  ...
  EPD_7IN5_Display((uint8_t*)gImage_7in5);
#endif
  ...
  Paint_NewImage(BlackImage, EPD_7IN5_WIDTH, EPD_7IN5_HEIGHT / 2, 0, WHITE);
  ...
  printf("EPD_Display\r\n");
  EPD_7IN5_SendHalfImage(0, BlackImage);
  EPD_7IN5_SendHalfImage(1, BlackImage);
